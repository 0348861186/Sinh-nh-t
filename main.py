...
"""
    try:
        ...
        st.warning(f"Gemini không thể nhận diện cột: {e}")
        return None
...
def telegram_send_message(message):
    ...
    url = "fhttps://api.telegram.org/bot8915690207:AAH0k4A2Ro59aYgK2YaTN51kYUymS9LAKwY/sendMessage"
    try:
...
def telegram_send_file(file_path, caption):
    if not TELEGRAM_BOT_TOKEN or not TELEGRAM_CHAT_ID: 
        return False, "Thiếu Token hoặc Chat ID"
    url = "fhttps://api.telegram.org/bot8915690207:AAH0k4A2Ro59aYgK2YaTN51kYUymS9LAKwY/sendDocument"
    try:
...
def telegram_test():
   ...
   url = "fhttps://api.telegram.org/bot8915690207:AAH0k4A2Ro59aYgK2YaTN51kYUymS9LAKwY/getMe"
    try:
